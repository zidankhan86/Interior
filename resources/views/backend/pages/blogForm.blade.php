        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <form action="{{ route('blog.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <br><br>
                        <h3 class="card-title" style="text-align: center">Blog Form</h3>
                        <div class="row row-cards">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="category_id" id="js-example-basic-single"
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="editors" rows="5" name="post_description" class="form-control"
                                        placeholder="Here can be your post description"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="hashtags" class="form-control"
                                        placeholder="E.g., #Health, #Game, #Tour">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-end">
                        <button type="submit" class="btn btn-primary"><span></span>Post Blog</button>
                    </div>
                </form>
            </div>
