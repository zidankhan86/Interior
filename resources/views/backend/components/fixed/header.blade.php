<header class="navbar navbar-expand-md d-none d-lg-flex d-print-none">
    <div class="container-xl">
        ...
        <div class="nav-item dropdown d-none d-md-flex me-3">
            <a href="{{ route('cache.clear') }}" class="nav-link px-0" tabindex="-1">
                <!-- Download SVG icon from http://tabler-icons.io/i/bell -->
                <button class="btn btn-success"><span><svg xmlns="http://www.w3.org/2000/svg" width="24"
        ...
        <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
                <a href="?theme=dark" class="nav-link px-0 hide-theme-dark" title="Enable dark mode"
                    ...
                    <Button class="btn btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="nav-item dropdown d-none d-md-flex me-3">
                    <a href="{{ route('home') }}" class="nav-link px-0" tabindex="-1">
                        <!-- Download SVG icon from http://tabler-icons.io/i/bell -->
                        <button class="btn btn-warning"><span>WEBSITE</span></button>
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <img height="50" width="50" src="{{ asset('/uploads/' . auth()->user()->image) }}"
                        alt="">
